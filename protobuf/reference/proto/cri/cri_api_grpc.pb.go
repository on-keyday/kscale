...
var RuntimeService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/cri/cri_api.proto",
}
...
const (
	TestService_TestUnary_FullMethodName               = "/runtime.v1.TestService/TestUnary"
	TestService_TestClientStream_FullMethodName        = "/runtime.v1.TestService/TestClientStream"
	TestService_TestServerStream_FullMethodName        = "/runtime.v1.TestService/TestServerStream"
	TestService_TestBidirectionalStream_FullMethodName = "/runtime.v1.TestService/TestBidirectionalStream"
)
...
type TestServiceClient interface {
	...
	TestClientStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TestRequest, TestResponse], error)
	TestServerStream(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[TestResponse], error)
	TestBidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TestRequest, TestResponse], error)
}
...
func (c *testServiceClient) TestClientStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TestRequest, TestResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[0], TestService_TestClientStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TestService_TestClientStreamClient = grpc.ClientStreamingClient[TestRequest, TestResponse]

func (c *testServiceClient) TestServerStream(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[TestResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[1], TestService_TestServerStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[TestRequest, TestResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TestService_TestServerStreamClient = grpc.ServerStreamingClient[TestResponse]

func (c *testServiceClient) TestBidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TestRequest, TestResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[2], TestService_TestBidirectionalStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[TestRequest, TestResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TestService_TestBidirectionalStreamClient = grpc.BidiStreamingClient[TestRequest, TestResponse]
...
type TestServiceServer interface {
	...
	TestClientStream(grpc.ClientStreamingServer[TestRequest, TestResponse]) error
	TestServerStream(*TestRequest, grpc.ServerStreamingServer[TestResponse]) error
	TestBidirectionalStream(grpc.BidiStreamingServer[TestRequest, TestResponse]) error
...
func (UnimplementedTestServiceServer) TestUnary(context.Context, *TestRequest) (*TestResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TestUnary not implemented")
}
func (UnimplementedTestServiceServer) TestClientStream(grpc.ClientStreamingServer[TestRequest, TestResponse]) error {
	return status.Error(codes.Unimplemented, "method TestClientStream not implemented")
}
func (UnimplementedTestServiceServer) TestServerStream(*TestRequest, grpc.ServerStreamingServer[TestResponse]) error {
	return status.Error(codes.Unimplemented, "method TestServerStream not implemented")
}
func (UnimplementedTestServiceServer) TestBidirectionalStream(grpc.BidiStreamingServer[TestRequest, TestResponse]) error {
	return status.Error(codes.Unimplemented, "method TestBidirectionalStream not implemented")
}
...
func _TestService_TestClientStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TestServiceServer).TestClientStream(&grpc.GenericServerStream[TestRequest, TestResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TestService_TestClientStreamServer = grpc.ClientStreamingServer[TestRequest, TestResponse]
...
func _TestService_TestServerStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TestServiceServer).TestServerStream(m, &grpc.GenericServerStream[TestRequest, TestResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TestService_TestServerStreamServer = grpc.ServerStreamingServer[TestResponse]

func _TestService_TestBidirectionalStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TestServiceServer).TestBidirectionalStream(&grpc.GenericServerStream[TestRequest, TestResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TestService_TestBidirectionalStreamServer = grpc.BidiStreamingServer[TestRequest, TestResponse]

// TestService_ServiceDesc is the grpc.ServiceDesc for TestService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var TestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "runtime.v1.TestService",
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "TestBidirectionalStream",
			Handler:       _TestService_TestBidirectionalStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
